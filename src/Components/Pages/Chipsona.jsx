...
import './Chipsona.css'; // Import your CSS file for styling
...
const Chipsona = () => {
  ...
  const handleSellClick = () => {
    ...
    navigate('/sell', { state: { potatoName: 'Chipsona' } });
  };

  return (
    <div className="potato-detail-container">
      <h1>Potato Variant: Chipsona</h1>
      <img src="../../assets/3.jpg" alt="Potato Chipsona" className="potato-image" />
